							...
							<td height="24" bgcolor="#353c44">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td>
											<div align="right">
												<span class="STYLE1"> <img src="images/add.gif" width="10" height="10" /><a style="color: white;" href="<%=path %>/admin/xuyuan/xuyuanAdd.jsp"> 添加 &nbsp;</a> </span><span class="STYLE1"> &nbsp;</span>
											</div>
										</td>
									</tr>
								</table>
				...
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()" onmouseout="changeback()">
                        ...
                        <tr>
							...
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<a style="color: red" href="<%=path %>/xibieMana.action?xuyuanId=<s:property value="#xuyuan.xuyuanId"/>">系别管理</a>
								</div>
							</td>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
								    <span class="STYLE10"><img width="10" height="10" src="<%=path %>/images/edit.gif" />&nbsp;&nbsp;&nbsp;<a style="color: red" href="<%=path %>/xuyuanEditPre.action?xuyuanId=<s:property value="#xuyuan.xuyuanId"/>">编辑</a></span>
								    &nbsp;&nbsp;&nbsp;&nbsp;
									<span class="STYLE10"><img width="10" height="10" src="<%=path %>/images/del.gif" />&nbsp;&nbsp;&nbsp;<a style="color: red" href="<%=path %>/xuyuanDel.action?xuyuanId=<s:property value="#xuyuan.xuyuanId"/>">删除</a></span>
								</div>
							</td>
						</tr>
                        </s:iterator>
